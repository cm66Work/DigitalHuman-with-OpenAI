...
namespace GPT3DigitalHuman.ChatBot
{
    public class ChatGPTController : MonoBehaviour
    {
        ...
        public async void GenerateResponce(Component sender, object data)
        {
            ...
            //_textToSpeachTrigger.Raise(this, "Sure, let me think.", true);
            ...
            _textToSpeachTrigger.Raise(this, result, true);
            _thinking = false;
        }

        public void ModelUpdated(Component sender, object data)
        {
